...
上游同步进度：截止 `886874b`（2026-05-14），表内上游提交已评估/合并/跳过；其中 `afc1dc3`（2026-05-15）以 squash 方式落地了下表「上游已合并」的那批提交。
> ⚠️ 上游 HEAD 自 2026-05-14 后未再核对，下次合并前需重新 fetch upstream 复核增量。
...
下表提交均已通过 `afc1dc3`（2026-05-15，squash `feat/upstream-merge-easy`）落地：
